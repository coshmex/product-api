...
public class DetallePController {
    ...
    @ResponseBody
    public List<Item> getproduct(HttpServletRequest request, @RequestParam(value = "id", defaultValue = "", required = false) String id, @RequestParam(value = "marca", defaultValue = "", required = false) String marca, @RequestParam(value = "clave", defaultValue = "", required = false) String clave, @RequestParam(value = "grupo", defaultValue = "", required = false) String grupo, @RequestParam(value = "codigo", defaultValue = "", required = false) String codigo) {
